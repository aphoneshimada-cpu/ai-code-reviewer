...
mkdir -p /home/ubuntu/ai-code-reviewer/screenshots

# Create mock screenshot data (base64 encoded minimal PNG)
# These are placeholder - in real scenario would be actual screenshots

cat > /home/ubuntu/ai-code-reviewer/screenshots/README.md << 'EOF'
# Screenshots
...
cat /home/ubuntu/ai-code-reviewer/screenshots/README.md
